...
const AddUser = () =>
{
    ...
    const onSubmit = async (e) =>
    {
        ...
        try {
            ...
            console.log('Add user response:', {success, message});
            if(success)
            {
                ...
                const errorMsg = message || 'Failed to add user. Please check your information and try again.';
                console.error('Add user failed:', errorMsg);
                toast.error(errorMsg);
            }
        } catch(error) {
            console.error('Add user error:', error);
            const errorMsg = error?.response?.data?.message || error.message || 'Failed to add user. Please try again.';
            toast.error(errorMsg);
        }
    }
